...
function renderPipelineStages(progress){
  ...
  const phases=[['前処理',['initializing','preparing']],['文献分析',['analyzing','llm_task','document_completed','document_failed','skipped','cooldown','checkpoint_reused']],['クラスタリング',['clustering','cluster_naming']],['結果確定',['completed']]];
